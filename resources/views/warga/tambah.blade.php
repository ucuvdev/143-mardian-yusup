<div class="modal fade modal-form" id="tambahWargaModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_jiwa" id="jml_jiwa"
                            placeholder="Jumlah Jiwa" autocomplete="off">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="simpan-warga">Simpan</button>
                </div>
            </form>
        </div>
    </div>
